...
class TaskA2 {
    public static void main (String [] args)  {
        String a="Я сразу смазал карту будня,";
        String b="плеснувши краску из стакана;";
        String c="я показал на блюде студня";
        String d="косые скулы океана.";
        String e="На чешуе жестяной рыбы";
        String f="прочёл я зовы новых губ.";
        String g="А вы ноктюрн сыграть могли бы";
        String h="на флейте водосточных труб?";
